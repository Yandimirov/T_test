...
@Component
public final class FloorMapperImpl implements FloorMapper {

  @Autowired
  private OfficeRepository officeRepository;

  @Override
  public Floor mapDtoToEntity(final FloorDto floorDto) {
  ...
  @Override
  public FloorDto mapEntityToDto(final Floor floor) {
