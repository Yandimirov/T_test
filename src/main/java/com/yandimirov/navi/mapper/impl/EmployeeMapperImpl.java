...
@Component
public final class EmployeeMapperImpl implements EmployeeMapper {
  ...
  @Override
  public Employee mapDtoToEntity(final EmployeeDto employeeDto) {
  ...
  @Override
  public EmployeeDto mapEntityToDto(final Employee employee) {
